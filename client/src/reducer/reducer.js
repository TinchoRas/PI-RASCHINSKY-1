import { GET_DOGS, GET_TEMPERAMENTS, FILTER_TEMPERAMENTS, FILTER_BY_ORIGIN, ORDER_BY_NAME, ORDER_BY_WEIGHT, SEARCH_DOGS, GET_DETAIL, CREATE_DOG, DELETE_DOG } from '../actions/acciones'
